...
(function(){
  ...
  angular
    .module('ion-gallery')
    .directive('ionImageOnload', ionImageOnload);

  ionImageOnload.$inject = [];

  function ionImageOnload() {
    return {
      restrict: 'A',
      link: link
    };
